    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{ env('STORAGE_URL') . '/' . $stores->logo }}" alt="">
              <a href="/details/{{$stores->id}}" class="add_cart_btn">
                <span>
                  View details
                </span>
              </a>
            ...
            <div class="detail-box">
              ...
              <div class="product_info">
                ...
                <div class="star_container">
                  ...
                  @for($x =1 ; $x <= round($stores->ratings->avg('rate')) ; $x++)
                    <i class="fa fa-star" aria-hidden="true" style="color: #FFFF00;"></i>

                    @endfor

                    @for($x =round($stores->ratings->avg('rate'))+1 ; $x <= 5 ; $x++) 
