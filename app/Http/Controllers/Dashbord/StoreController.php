...
class StoreController extends Controller
{
    ...
    {
        $store = Category::get();
        return view('dashbord.store.create')->with('store', $store);
    }
    ...
    public function index()
    {
        ...
        return view('dashbord.store.index')->with('stores', $stores);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashbord.store.edit')->with('store', $store)->with('categories',$category);
    }
